                            ...
                            <div class="card-body card-block">
                                <form  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col col-md-9">
                                            <div class="form-check">
                                                <div class="radio">
                                                    <label for="radio1" >
                                                        <input type="radio" id="radio1" name="tinh_trang"value="Còn hàng" class="form-check-input">Còn hàng
                                                    </label>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="image" width="20%" name="anh_sp" class="form-control-image"><input type="file" id="file-input" name="anh_sp" class="form-control-file"></div>
                                    </div>
                                    <div class="row form-group">
