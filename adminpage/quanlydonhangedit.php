            ...
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form action="controller/donhangeditcontroller.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        ...
                                        <select name="sel_sanpham" class="form-control">
                                            ...
                                            <?php
                                            $arrSoThich = array("1" => "Very Easy Toeic 2 - Build Up", "2" => "Chưa xử lý");
                                            foreach ($arrSoThich as $key => $value) {
                                                if ($key == "1")
                                                    echo '<option value="' . $value . '"selected="selected">' . $value . '</option>';
                                                else
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">  <button type="submit" class="btn btn-primary" name="bnt_XuLy" value="submit">
